                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="bno" class="form-control" id="exampleInputEmail10"
                                       placeholder="blank bno" value="<c:out value="${boardDTO.bno}"></c:out>" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12"> <!-- 6은 절반 12는 전체 -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="content" class="form-control" rows="3" placeholder="Enter ..."
                                                  disabled><c:out value="${boardDTO.content}"></c:out></textarea>
                                        <!-- textarea는 공백조심 -->
                                    </div>
                                </div>
